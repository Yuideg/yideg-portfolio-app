...
export const experience = [
    ...
    },
    {
        ...
        desc: "As a seasoned front-end web developer, I have leveraged the power of React framework with Redux and React-Query state management to deliver professional-grade applications. Additionally, I have showcased my proficiency in Vue.js, utilizing GraphQL, Vuex, Vuetify, and other supplementary frameworks to create seamless user experiences. Moreover, I have effectively implemented Apollo Client with Hasura for efficient data fetching and manipulation.",
        descBullets: [],
        color:deepPurple[500]
    ...
    },
    {
        ...
        desc:"During a one-month contract, I successfully served as a backend developer for a European client, utilizing my expertise in Python, Django, and PostgreSQL. Within this timeframe, I contributed to the development and implementation of the project's backend functionalities, ensuring seamless data management and integration. My ability to deliver results within strict deadlines and collaborate effectively with international clients makes me a valuable asset to any development team.",
        descBullets: [],
        color:deepPurple[500]
